...
import { checkingAuth, startGitHubSignIn, startGoogleSingIn } from "../../store/auth/thunks"
    ...
    <AuthLayout>
      <div className="container-main">
        ...
        <div className="container-providers">
          <button onClick={onGoogleLogin} type="submit">
          ...
          <button onClick={onGithubSLogin} type="submit">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="form">
          ...
          <input autoComplete="off" name="email" placeholder="Correo" className="input-control" type="text" {...register('email', {
          ...
          {errors.email ? <p className="error-mensage-form">{errors.email?.message}</p> : ''}

          <input autoComplete="off" name="password" placeholder="Contraseña" className="input-control" type="password" {...register('password', {
            required: 'Este campo es requerido',
            minLength: {
              value: 6,
          ...
          {errors.password ? <p className="error-mensage-form">{errors.password?.message}</p> : ''}
